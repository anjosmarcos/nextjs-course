            ...
            {pages.map((page, index) => {
                ...
                if (isEllipsis) {
                    return (
                        <li
                            key={page}
                            className="border-x border-indigo-400/40 first:rounded-l last:rounded-r first:border-0">
                            <span
                ...
                return (
                    <li
                        ...
                        <Link
                            href={url}
                            className={cn('flex h-10 items-center justify-center bg-slate-700 hover:bg-indigo-400/40 px-4 hover:text-slate-300', {
